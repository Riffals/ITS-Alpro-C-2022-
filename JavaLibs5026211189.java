...
public class JavaLibs5026211189 {
  public static void main(String args[]) {
    ...
    System.out.println("How many kilograms of carrot do you want to buy?");
    ...
    double carrotprice = carrot * 7_000.00;
    double milkprice = milk * 18_000.00;

    double totalprice = wafersprice + cookiesprice + chipsprice + icecreamprice + spinachprice + carrotprice
        + milkprice;
    ...
    System.out.println(chips + " packs of chips, " + spinach + " kilograms of apples and  ");
    System.out.println(+ carrot + " kilograms of oranges. After take all items he needed, ");
